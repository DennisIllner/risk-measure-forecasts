...
#Model Fit GARCH(1,1)-N and one-step ahead forecasts to 15.3
...
sigma_hat
f <- function(l, fit) qnorm(p=l, mean=0, sd=1) #define quantile function
...
#Model Fit GARCH(1,1)-N and one-step ahead forecasts to 20.3
...
sigma_hat1
f <- function(l, fit) qnorm(p=l, mean=0, sd=1) 
...
#Model Fit AR(1)-GARCH(1,1)-N and one-step ahead forecasts to 15.3
...
#Model Fit AR(1)-GARCH(1,1)-N and one-stept ahead forecasts to 20.3
