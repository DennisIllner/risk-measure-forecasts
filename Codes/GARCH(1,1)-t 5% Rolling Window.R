...
ts.t<-ggplot(data=RollingWindow,aes(x=Date, y=lret))+
...
ggsave(filename = "C:/Users/illne/Desktop/Uni/6.Semester/Seminar Ökonometrie/Paper/Rolling Window GARCH(1,1)-t.png", plot = ts.t, dpi = 600, width = 8, height = 5)
